...
<head>
    ...
    <style>
        ...
        * {
        ...
        .button-danger {
            background: linear-gradient(135deg, #c95742, #a33d2c);
            color: #fff;
            border: none;
            box-shadow: 0 14px 28px rgba(163, 61, 44, 0.2);
        }

        .button-danger:hover {
            box-shadow: 0 18px 30px rgba(163, 61, 44, 0.24);
        }
...
<?php /**PATH D:\SE\final\bakery-webapp\resources\views/layouts/app.blade.php ENDPATH**/ ?>