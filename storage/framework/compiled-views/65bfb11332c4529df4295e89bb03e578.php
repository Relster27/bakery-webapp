        ...
        <div class="hero-grid">
            <div>
                ...
                <div class="actions">
                    ...
                    <a class="button-inline" href="<?php echo e(route('discounts.index')); ?>">Flash Sale Rules</a>
                    <a class="button-inline" href="<?php echo e(route('analytics.index')); ?>">Sales Analytics</a>
                </div>
            </div>
