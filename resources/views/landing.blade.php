...
@section('content')
    <section class="landing-hero">
        <div class="landing-hero-copy">
            ...
            <div class="actions">
                <a class="button-inline" href="{{ route('register') }}">Create Owner Account</a>
                <a class="button-inline button-secondary" href="{{ route('login') }}">Login</a>
            </div>
    ...
    <section class="landing-cta">
        ...
        <div class="actions">
            <a class="button-inline" href="{{ route('login') }}">Open Login</a>
            <a class="button-inline button-secondary" href="{{ route('register') }}">Open Register</a>
        </div>
    </section>
@endsection
